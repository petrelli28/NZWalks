...
namespace NZWalks.API.Controllers
{
    ...
    public class RegionsController : Controller
    {
        ...
        public async Task<IActionResult> AddRegionAsync(Models.DTO.AddRegionRequest addRegionRequest)
        {
            ...
            //return CreatedAtAction("GetRegionAsync", new {id = regionDTO.Id}, regionDTO);
        ...
        private bool ValidateAddRegionAsync(Models.DTO.AddRegionRequest addRegionRequest)
        {
            ...
            {
                ModelState.AddModelError(nameof(addRegionRequest.Area), $"{nameof(addRegionRequest.Area)} cannot be equal or less than zero.");
            }
        ...
        private bool ValidateUpdateRegionAsync(Models.DTO.UpdateRegionRequest updateRegionRequest)
        {
            ...
            {
                ModelState.AddModelError(nameof(updateRegionRequest.Area), $"{nameof(updateRegionRequest.Area)} cannot be equal or less than zero.");
            }
